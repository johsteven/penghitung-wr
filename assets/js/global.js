function welcomeMsg() {
    ...
    const msg3 = `<p class="animation mb-0 text-truncate">Buat yang mau namanya dipajang disini, pc ya</p>`;
    ...
    let arrayEl = [msg1, msg2, msg3, msg4, msg5, msg6, msg7, msg8, msg9, msg10, msg11, msg12, msg13];
    let arrayMax = 13;
    setInterval(() => {
